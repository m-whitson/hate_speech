...
The final ipynb can't always be rendered on Github due to its size, so it can also be viewed [here](https://nbviewer.jupyter.org/github/m-whitson/hate_speech/blob/master/ds_report.ipynb)
